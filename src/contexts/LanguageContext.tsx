...
export const translations: Translations = {
  ...
  'nav.menuAndPages': { en: 'Menu & Pages Management', he: 'ניהול תפריט ודפים' },
  'nav.addNewPage': { en: 'Add New Page', he: 'הוספת דף חדש' },
  'nav.addNewPageDesc': { en: 'Create a custom page with rich text content', he: 'יצירת דף מותאם אישית עם תוכן עשיר' },
  'nav.pageTitleHe': { en: 'Page Title (Hebrew)', he: 'כותרת הדף (עברית)' },
  'nav.pageTitleEn': { en: 'Page Title (English)', he: 'כותרת הדף (אנגלית)' },
  'nav.pageTitlePlaceholder': { en: 'Enter page title...', he: 'הזנת כותרת הדף...' },
  'nav.pageTitlePlaceholderEn': { en: 'Enter page title in English...', he: 'הזנת כותרת הדף באנגלית...' },
  'nav.pageIcon': { en: 'Page Icon', he: 'אייקון הדף' },
  'nav.pageContent': { en: 'Page Content', he: 'תוכן הדף' },
  'nav.pageContentPlaceholder': { en: 'Write your page content here...', he: 'כתוב את תוכן הדף כאן...' },
  'nav.createPage': { en: 'Create Page', he: 'יצירת דף' },
  'nav.pageCreated': { en: 'Page created successfully', he: 'הדף נוצר בהצלחה' },
  'nav.editPage': { en: 'Edit Page', he: 'עריכת דף' },
  'nav.editPageDesc': { en: 'Update page title and content', he: 'עדכון כותרת ותוכן הדף' },
  'nav.pageUpdated': { en: 'Page updated successfully', he: 'הדף עודכן בהצלחה' },
  'nav.reorderTabs': { en: 'Reorder Tabs', he: 'שינוי סדר טאבים' },
  'nav.reorderTabsDesc': { en: 'Drag and drop to reorder, toggle visibility for users', he: 'גרור ושחרר לשינוי הסדר, החלף נראות למשתמשים' },
  'nav.orderSaved': { en: 'Tab order saved', he: 'סדר הטאבים נשמר' },
  'nav.tabShown': { en: 'Tab is now visible', he: 'הטאב מוצג כעת' },
  'nav.tabHidden': { en: 'Tab is now hidden', he: 'הטאב מוסתר כעת' },
  'nav.deleteTab': { en: 'Delete Tab', he: 'מחיקת טאב' },
  'nav.deleteTabConfirm': { en: 'Are you sure you want to delete "{name}"? This action cannot be undone.', he: 'האם למחוק את "{name}"? פעולה זו לא ניתנת לביטול.' },
  'nav.tabDeleted': { en: 'Tab deleted successfully', he: 'הטאב נמחק בהצלחה' },
  'nav.titleRequired': { en: 'Page title is required', he: 'כותרת הדף נדרשת' },
  'nav.system': { en: 'System', he: 'מערכת' },
  'nav.customPage': { en: 'Custom', he: 'מותאם' },
  'nav.noContent': { en: 'This page has no content yet', he: 'לדף זה אין עדיין תוכן' },
};
